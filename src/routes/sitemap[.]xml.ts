    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/redact-pdf", changefreq: "weekly", priority: "0.8" },
          { path: "/split-pdf-by-size", changefreq: "weekly", priority: "0.8" },
          { path: "/add-header-footer-pdf", changefreq: "weekly", priority: "0.8" },
          { path: "/fill-pdf-form", changefreq: "weekly", priority: "0.8" },
          { path: "/extract-pdf-images", changefreq: "weekly", priority: "0.8" },
          { path: "/remove-blank-pages-pdf", changefreq: "weekly", priority: "0.8" },
          ...
          { path: "/pdf-conversion-guide", changefreq: "weekly", priority: "0.8" },
        ];
